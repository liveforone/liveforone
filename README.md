...
* 저는 코드 뿐만 아니라 다양한 방법으로 이러한 비즈니스 문제를 풀어가는것을 좋아합니다.

## School
* 🎓School : HanSung University in Seoul
* 🎓Major : Computer Science 2022~
## Skill
* Spring Framework(Boot), Spring Security, 
* Spring Cloud, Docker
* Kafka
* Java
* Jwt
* MySql, Query Dsl, Spring Data Jpa
* thymeleaf
* Junit4, Junit5
## About Project
...
* 제 프로젝트가 "좋은 프로젝트, 좋은 코드, 좋은 문서화"의 교과서 역할을 하는 프로젝트가 되길 바라며 작업합니다.
## Etc..
